...
<body class="bg-gray-200">
    <div class="min-h-screen flex items-center justify-center bg-gray-100 w-11/12 md:w-4/5 m-auto">
        ...
        <div class="bg-white p-16 rounded-2xl shadow-md hover:shadow-lg w-full md:w-2/3 lg:w-1/2 xl:w-1/3">
            ...
            <h3 class="text-3xl font-semibold mb-10 texte-gray-700">Apply for Admin</h3>
            ...
            <form action="" class="space-y-5">
                ...
                <div>
                    ...
                    <label for="checkbox" class="ml-2 text-gray-500 text-sm">I agree to the terms and privacy</label>
                </div>

                <input type="submit" value="Apply" class="w-full button">
